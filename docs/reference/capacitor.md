# Capacitor schema reference

Generated from `schema/capacitor.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `capacitor`
- Indicator: `C`
- Required top level fields: `name`
- Example instance: [`examples/testCapacitor.json`](../examples/testCapacitor.json)
- Narrative guide: [Capacitor](../capacitor.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `capacitor` | = `capacitor` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
