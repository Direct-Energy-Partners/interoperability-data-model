# Combiner Box schema reference

Generated from `schema/combinerBox.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `combinerBox`
- Indicator: `A`
- Required top level fields: `name`
- Example instance: [`examples/testCombinerBox.json`](../examples/testCombinerBox.json)
- Narrative guide: [Combiner Box](../combinerBox.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `combinerBox` | = `combinerBox` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
...
| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `ports` | array of objects |  | `[3 items]` |  |
