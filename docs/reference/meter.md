# Meter schema reference

Generated from `schema/meter.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `meter`
- Indicator: `P`
- Required top level fields: `name`
- Example instance: [`examples/testMeter.json`](../examples/testMeter.json)
- Narrative guide: [Meter](../meter.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `meter` | = `meter` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
