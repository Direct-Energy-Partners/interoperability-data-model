# Panel Switchboard schema reference

Generated from `schema/panel.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `panel`
- Indicator: `A`
- Required top level fields: `name`
- Example instance: [`examples/testPanel.json`](../examples/testPanel.json)
- Narrative guide: [Panel Switchboard](../panel.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `panel` | = `panel` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
