# Precharge schema reference

Generated from `schema/precharge.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `precharge`
- Indicator: `PRE`
- Required top level fields: `name`
- Example instance: [`examples/testPrecharge.json`](../examples/testPrecharge.json)
- Narrative guide: [Precharge](../precharge.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `precharge` | = `precharge` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
