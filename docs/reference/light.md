# Light schema reference

Generated from `schema/light.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `light`
- Indicator: `LIGHT`
- Required top level fields: `name`
- Example instance: [`examples/testLight.json`](../examples/testLight.json)
- Narrative guide: [Light](../light.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `light` | = `light` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
