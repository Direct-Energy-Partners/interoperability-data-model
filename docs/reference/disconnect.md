# Disconnect schema reference

Generated from `schema/disconnect.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `disconnect`
- Indicator: `Q`
- Required top level fields: `name`
- Example instance: [`examples/testDisconnect.json`](../examples/testDisconnect.json)
- Narrative guide: [Disconnect](../disconnect.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `disconnect` | = `disconnect` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
