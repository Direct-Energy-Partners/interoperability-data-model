# Fuel Cell schema reference

Generated from `schema/fuelCell.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `fuelCell`
- Indicator: `FC`
- Required top level fields: `name`
- Example instance: [`examples/testFuelCell.json`](../examples/testFuelCell.json)
- Narrative guide: [Fuel Cell](../fuelCell.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `fuelCell` | = `fuelCell` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
