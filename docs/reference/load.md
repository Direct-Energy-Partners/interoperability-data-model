...
Generated from `schema/load.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `load`
- Indicator: `LOAD`
- Required top level fields: `name`
- Example instance: [`examples/testLoad.json`](../examples/testLoad.json)
- Narrative guide: [Load](../load.md)
