# Transfer Switch schema reference

Generated from `schema/transferSwitch.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `transferSwitch`
- Indicator: `Q`
- Required top level fields: `name`
- Example instance: [`examples/testTransferSwitch.json`](../examples/testTransferSwitch.json)
- Narrative guide: [Transfer Switch](../transferSwitch.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `transferSwitch` | = `transferSwitch` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
...
| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `ports` | array of objects |  | `[null, null, null]` |  |
| `standards` | array of string |  | `[]` |  |
