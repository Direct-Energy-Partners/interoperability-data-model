# Motor schema reference

Generated from `schema/motor.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `motor`
- Indicator: `M`
- Required top level fields: `name`
- Example instance: [`examples/testMotor.json`](../examples/testMotor.json)
- Narrative guide: [Motor](../motor.md)
