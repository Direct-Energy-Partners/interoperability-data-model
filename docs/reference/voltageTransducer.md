# Voltage Transducer schema reference

Generated from `schema/voltageTransducer.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `voltageTransducer`
- Indicator: `PT`
- Required top level fields: `name`
- Example instance: [`examples/testVoltageTransducer.json`](../examples/testVoltageTransducer.json)
- Narrative guide: [Voltage Transducer](../voltageTransducer.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `voltageTransducer` | = `voltageTransducer` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
...
| `accuracy` | measurement |  | `{}` | fields: value; unit `%` |
| `responseTime` | measurement |  | `{}` | fields: value; unit `s` |
...
| `AC` | object |  | `{}` |  |
| `DC` | object |  | `{}` |  |
| `overvoltageCategory` | number |  | `null` | nullable |
