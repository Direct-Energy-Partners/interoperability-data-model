# Contactor schema reference

Generated from `schema/contactor.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `contactor`
- Indicator: `K`
- Required top level fields: `name`
- Example instance: [`examples/testContactor.json`](../examples/testContactor.json)
- Narrative guide: [Contactor](../contactor.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `contactor` | = `contactor` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
