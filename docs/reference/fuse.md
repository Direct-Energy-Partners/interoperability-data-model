# Fuse schema reference

Generated from `schema/fuse.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `fuse`
- Indicator: `F`
- Required top level fields: `name`
- Example instance: [`examples/testFuse.json`](../examples/testFuse.json)
- Narrative guide: [Fuse](../fuse.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `fuse` | = `fuse` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
...
| `meltingI2t` | measurement |  | `{}` | fields: value; unit `A²•s` |
| `arcingI2t` | measurement |  | `{}` | fields: value; unit `A²•s` |
| `totalClearingI2t` | measurement |  | `{}` | fields: value; unit `A²•s` |
| `i2tCurve` | array of objects |  | `[]` |  |
...
| `minimumBreakingCapacity` | measurement |  | `{}` | fields: value; unit `A` |
...
| `criticalClearingTime` | measurement |  | `{}` | fields: value; unit `s` |
| `minimumBreakingCapacity` | measurement |  | `{}` | fields: value; unit `A` |
| `maximumTimeConstant` | measurement |  | `{}` | fields: value; unit `s` |
