# Converter schema reference

Generated from `schema/converter.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `converter`
- Indicator: `U`
- Required top level fields: `name`
- Example instance: [`examples/testConverter.json`](../examples/testConverter.json)
- Narrative guide: [Converter](../converter.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `converter` | = `converter` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
...
| `resistance` | measurement |  | `{}` | fields: value; unit `ohm` |
| `inductance` | measurement |  | `{}` | fields: value; unit `H` |
| `faultFeedingPorts` | array of number |  | `[]` |  |

#### `electrical.efficiency`

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `powerSeries` | measurement |  | `{}` | fields: value; unit `W` |
| `efficiencySeries` | measurement |  | `{}` | fields: value; unit `%` |
