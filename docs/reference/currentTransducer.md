# Current Transducer schema reference

Generated from `schema/currentTransducer.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `currentTransducer`
- Indicator: `CT`
- Required top level fields: `name`
- Example instance: [`examples/testCurrentTransducer.json`](../examples/testCurrentTransducer.json)
- Narrative guide: [Current Transducer](../currentTransducer.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `currentTransducer` | = `currentTransducer` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
