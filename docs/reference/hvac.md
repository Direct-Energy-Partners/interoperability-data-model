# HVAC schema reference

Generated from `schema/hvac.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `hvac`
- Indicator: `HVAC`
- Required top level fields: `name`
- Example instance: [`examples/testHvac.json`](../examples/testHvac.json)
- Narrative guide: [HVAC](../hvac.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `hvac` | = `hvac` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
...
| `purpose` | string |  |  | one of `battery`, `solar`; nullable |
