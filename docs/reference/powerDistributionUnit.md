# Power Distribution Unit schema reference

Generated from `schema/powerDistributionUnit.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `powerDistributionUnit`
- Indicator: `PDU`
- Required top level fields: `name`
- Example instance: [`examples/testPowerDistributionUnit.json`](../examples/testPowerDistributionUnit.json)
- Narrative guide: [Power Distribution Unit](../powerDistributionUnit.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `powerDistributionUnit` | = `powerDistributionUnit` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
...
| `id` | string |  |  |  |
| `electrical` | object |  | `{}` |  |
| `compatibleProducts` | array of string |  | `[]` |  |
...
| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `ports` | array of objects |  | `[2 items]` |  |
