...
Generated from `schema/generator.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `generator`
- Indicator: `G`
- Required top level fields: `name`
- Example instance: [`examples/testGenerator.json`](../examples/testGenerator.json)
- Narrative guide: [Generator](../generator.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `generator` | = `generator` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
