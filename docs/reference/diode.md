# Diode schema reference

Generated from `schema/diode.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `diode`
- Indicator: `D`
- Required top level fields: `name`
- Example instance: [`examples/testDiode.json`](../examples/testDiode.json)
- Narrative guide: [Diode](../diode.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `diode` | = `diode` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
