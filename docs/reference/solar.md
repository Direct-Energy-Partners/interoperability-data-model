# Solar Panel schema reference

Generated from `schema/solar.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `solar`
- Indicator: `PV`
- Required top level fields: `name`
- Example instance: [`examples/testSolar.json`](../examples/testSolar.json)
- Narrative guide: [Solar Panel](../solar.md)
