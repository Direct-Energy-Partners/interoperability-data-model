# Hydro schema reference

Generated from `schema/hydro.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `hydro`
- Indicator: `HYDRO`
- Required top level fields: `name`
- Example instance: [`examples/testHydro.json`](../examples/testHydro.json)
- Narrative guide: [Hydro](../hydro.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `hydro` | = `hydro` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
