# Utility schema reference

Generated from `schema/utility.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `utility`
- Indicator: `GRID`
- Required top level fields: `name`
- Example instance: [`examples/testUtility.json`](../examples/testUtility.json)
- Narrative guide: [Utility](../utility.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `utility` | = `utility` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
