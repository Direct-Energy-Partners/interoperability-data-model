# Wind schema reference

Generated from `schema/wind.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `wind`
- Indicator: `WIND`
- Required top level fields: `name`
- Example instance: [`examples/testWind.json`](../examples/testWind.json)
- Narrative guide: [Wind](../wind.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `wind` | = `wind` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
