# Rapid Shutdown Device schema reference

Generated from `schema/rapidShutdownDevice.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `rapidShutdownDevice`
- Indicator: `RSD`
- Required top level fields: `name`
- Example instance: [`examples/testRapidShutdownDevice.json`](../examples/testRapidShutdownDevice.json)
- Narrative guide: [Rapid Shutdown Device](../rapidShutdownDevice.md)
