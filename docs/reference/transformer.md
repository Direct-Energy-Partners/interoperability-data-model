# Transformer schema reference

Generated from `schema/transformer.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `transformer`
- Indicator: `T`
- Required top level fields: `name`
- Example instance: [`examples/testTransformer.json`](../examples/testTransformer.json)
- Narrative guide: [Transformer](../transformer.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `transformer` | = `transformer` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
...
| `powerFlowDirection` | string |  | `bidirectional` | one of `bidirectional`, `input`, `output`; nullable |
| `terminal` | object |  | `{}` |  |
| `wireSize` | object |  | `{}` |  |
| `AC` | object |  | `{}` |  |
| `isolated` | boolean |  | `true` | nullable |
