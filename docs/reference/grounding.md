# Grounding schema reference

Generated from `schema/grounding.json` by `scripts/gen_schema_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `grounding`
- Indicator: `GND`
- Required top level fields: `name`
- Example instance: [`examples/testGrounding.json`](../examples/testGrounding.json)
- Narrative guide: [Grounding](../grounding.md)

## Top level attributes

| Field | Type | Required | Default | Allowed / notes |
| --- | --- | --- | --- | --- |
| `type` | const |  | `grounding` | = `grounding` |
| `name` | string | yes |  |  |
| `description` | string |  | `""` |  |
...
| `AC` | object |  | `{}` |  |
| `DC` | object |  | `{}` |  |
| `earthingImpedance` | measurement |  | `{}` | fields: value; unit `ohm` |
...
| `groundingConfiguration` | string |  | `TN-S` | one of `TN-S`, `TN-C`, `IT`, `TT`, `unearthed` |
...
| `groundingConfiguration` | string |  | `TN-S` | one of `TN-S`, `IT`, `unearthed` |
