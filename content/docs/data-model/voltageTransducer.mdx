...
description: Voltage Transducer
---
...
See [`examples/testVoltageTransducer.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testVoltageTransducer.json).
