...
See [`examples/testCombinerBox.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testCombinerBox.json).
