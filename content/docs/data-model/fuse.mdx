...
See [common attributes](./common) for the rest of the shared base every component carries
...
See [`examples/testFuse.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testFuse.json).
