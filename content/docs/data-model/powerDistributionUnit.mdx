...
See [`examples/testPowerDistributionUnit.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testPowerDistributionUnit.json).
