...
set of control method enum values is listed in [common attributes](./common).
...
See [`examples/testGenerator.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testGenerator.json).
