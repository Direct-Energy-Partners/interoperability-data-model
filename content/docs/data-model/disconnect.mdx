...
[common attributes](./common): `constant-voltage-frequency`,
...
See [`examples/testDisconnect.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testDisconnect.json).
