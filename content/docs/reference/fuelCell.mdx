---
title: Fuel Cell
description: Field level schema reference for the Fuel Cell component type.
---

Generated from `schema/fuelCell.json` by `scripts/gen_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `fuelCell`
- Indicator: `FC`
- Required top level fields: `name`
- Narrative guide: [Fuel Cell](../data-model/fuelCell)
- Example instance: [`examples/testFuelCell.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testFuelCell.json)
