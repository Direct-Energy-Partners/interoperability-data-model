---
title: Grounding
description: Field level schema reference for the Grounding component type.
---

Generated from `schema/grounding.json` by `scripts/gen_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `grounding`
- Indicator: `GND`
- Required top level fields: `name`
- Narrative guide: [Grounding](../data-model/grounding)
- Example instance: [`examples/testGrounding.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testGrounding.json)
