---
title: Panel Switchboard
description: Field level schema reference for the Panel Switchboard component type.
---

Field level reference for the Panel Switchboard component type, as defined by [`schema/panel.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/schema/panel.json), the source of truth.

- Type key: `panel`
- Indicator: `A`
- Required top level fields: `name`
- Narrative guide: [Panel Switchboard](../data-model/panel)
- Example instance: [`examples/testPanel.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testPanel.json)
