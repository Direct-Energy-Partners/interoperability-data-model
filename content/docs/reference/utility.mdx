---
title: Utility
description: Field level schema reference for the Utility component type.
---

Generated from `schema/utility.json` by `scripts/gen_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `utility`
- Indicator: `GRID`
- Required top level fields: `name`
- Narrative guide: [Utility](../data-model/utility)
- Example instance: [`examples/testUtility.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testUtility.json)
