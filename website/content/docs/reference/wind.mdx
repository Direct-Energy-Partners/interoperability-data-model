---
title: Wind
description: Field level schema reference for the Wind component type.
---

Generated from `schema/wind.json` by `scripts/gen_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `wind`
- Indicator: `WIND`
- Required top level fields: `name`
- Narrative guide: [Wind](../data-model/wind)
- Example instance: [`examples/testWind.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testWind.json)
