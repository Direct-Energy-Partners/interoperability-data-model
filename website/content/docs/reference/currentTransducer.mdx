...
Generated from `schema/currentTransducer.json` by `scripts/gen_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.
