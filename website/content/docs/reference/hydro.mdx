---
title: Hydro
description: Field level schema reference for the Hydro component type.
---

Generated from `schema/hydro.json` by `scripts/gen_docs.py`. The schemas are the source of truth (dcide-app validators). Do not edit this page by hand.

- Type key: `hydro`
- Indicator: `HYDRO`
- Required top level fields: `name`
- Narrative guide: [Hydro](../data-model/hydro)
- Example instance: [`examples/testHydro.json`](https://github.com/Direct-Energy-Partners/interoperability-data-model/blob/main/examples/testHydro.json)
